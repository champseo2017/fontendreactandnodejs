...
class User extends Component {
  ...
  // สั่ง dispatch ฟังก์ชั่น loadUsers
  componentDidMount() {
      ...
      <div>
        ...
        <div className="form-group row">
          <div className="col-sm-6">
            {/* 
                            ส่ง props onSearchTermChange ให้ Component SearchBar เพื่อ filgter โดยฝั่ง SearchBar จะนำไปใช้กับ event onChange 
                        */}
            <SearchBar
        ...
        {/*
            เป็น Component สำหรับแสดง Model ของ reactstrap
  ...
  // ฟังก์ชั่นสั่งแสดง เปิด/ปิด modal
  toggle = () => {
      this.setState({
  ...
  // ฟังก์ชั่นแก้ไขข้อมูล และสั่งให้เปิด Modal โดยจะส่งข้อมูลไปแป๊ะกับฟอร์มด้วย
  handleEdit = (id) => {
      this.props.dispatch(resetStatus())
