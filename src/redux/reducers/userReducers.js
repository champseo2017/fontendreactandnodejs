...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case "LOAD_USER_SUCCESS":
      return {
        ...state,
        user: { data: action.payload, isLoading: false, isRejected: false }
      };
    case "LOAD_USER_REJECTED":
      return {
        ...state,
        user: { data: action.payload, isLoading: false, isRejected: true }
      };
    // เก็บ state การลบข้อมูลผู้ใช้
    case "DELETE_USER_SUCCESS":
      return {
        ...state,
        userDelete: { data: true, isLoading: false, isRejected: false }
      };
    case "DELETE_USER_REJECTED":
      return {
        ...state,
        userDelete: { data: action.payload, isLoading: false, isRejected: true }
      };
    ...
    case "SAVE_USER_SUCCESS":
      return {
        ...state,
        userSave: { data: null, isLoading: false, isRejected: false }
      };
    case "SAVE_USER_REJECTED":
      return {
        ...state,
        userSave: { data: action.payload, isLoading: false, isRejected: true }
      };
    default:
      return state;
  }
